...
Can we inject PHP to list files on the folder, 
...
Can we get a reverse shell ?  can get connections, but they drop straight away. Attempted to use msfconsole and listeners such as exploit/multi/handler  PAYLOAD php/meterpreter/reverse_tcp but unfortunately didn't work.  Might revisit another time
